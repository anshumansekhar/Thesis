            ...
            <td colspan="2" style="background: #fff; border-radius: 8px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr class="">
                      <td class="grid__col" style="font-family: 'Helvetica neue', Helvetica, arial, sans-serif; padding: 32px 40px; ">
                        ...
                        <p style="color: #666666; font-weight: 400; font-size:  15px; line-height: 21px; font-family: 'Helvetica neue', Helvetica, arial, sans-serif; " class="">
                            Your train ticket booking confirmed for <%out.print(request.getParameter("trainNumber"))%> on <%out.print(request.getParameter("date"))%>.Please review the details of your booking.
                        </p>
                        <table width="100%" border="2" cellspacing="0" cellpadding="0" style="margin-top: 12px; margin-bottom: 12px; margin: 24px 0; color: #666666; font-weight: 400; font-size: 15px; line-height: 21px; font-family: 'Helvetica neue', Helvetica, arial, sans-serif;" >
                            <tr>
                                <td style="padding:20px 20px 0px ; font-weight:700; font-size: 25px; ">
                                    <p style="padding-top:0px; font-weight:700; font-size: 12px; ">Booking Confirmation Code: <%out.print(request.getParameter("bookingCode"))%></p>
                                </td>
                            </tr>
                            <tr> 
                                <td style="width: 100% !important; max-width: 480px !important; height: auto !important;">
                            ...
                            <tr>
                                <td style="padding:20px 20px 10px ; font-weight:700; font-size: 18px; ">
                                    ...
                                    <p style="padding-top:0px; font-weight:700; font-size: 12px; ">
                                        <%out.print(request.getParameter("departCity"))%> - <%out.print(request.getParameter("arrivalCity"))%>
                                    </p>
                                </td>
                                <td style="padding:20px 20px 10px ; font-weight:700; font-size: 18px; ">
                                    <%out.print(request.getParameter("classType"))%>
                                </td>
                           </tr>
                           <tr>
                               <td>
                                   <table style="width: 100%;!important">
                                        <tr>
                                            <td style="  padding:20px 20px 0px 30px ; font-weight:700; font-size: 14px;">
                                                Depart
                                            </td>
                                            <td style=" colspan=2; padding:20px 20px 0px 20px ; font-weight:700; font-size: 14px;">
                                                Arrive
                                            </td>
                                    ...
                                    <tr>
                                        <td style=" colspan=2; padding: 0px 20px 20px 20px ; font-weight:700; font-size: 18px;">
                                            <%out.print(request.getParameter("departTime"))%>
                                        </td>
                        ...
                        <tr>
                            <td  style="padding:5px 5px 0px 20px; font-weight:700; font-size: 12px; ">
                            ...
                            <td>
                                <table style="width: 100%;!important">
                                    <tr>
                                        ...
                                        <td style=" padding:5px 20px 10px 20px ; font-weight:400; font-size: 14px;">
                                    ...
                                    <tr>    
                                        <td style=" colspan=2; padding:5px 20px 10px 20px ; font-weight:700; font-size: 14px; color:#000">
                                            Grand Total 
                                        </td>
                                        <td  style=" padding:5px 20px 10px 30px ; font-weight:700; font-size: 14px; color:#000;">
                                            ₹ <%out.print(Float.valueOf(request.getParameter("amount"))+Float.valueOf(request.getParameter("tax")))%>
                                        </td>
                                    </tr>  
                                    <tr>    
                                        <td style=" colspan=2; padding:5px 20px 10px 20px ; font-weight:700; font-size: 14px;">
                                            Payment Mode 
                                        </td>
                                        <td  style=" padding:5px 20px 10px 30px ; font-weight:700; font-size: 14px; ">
                                            <%out.print(request.getParameter("paymentMode"))%>
                                        </td>
                                    </tr>                        
                                </table>
                            </td>
                ...
                <%
                    ...
                    {
                        out.print("<td>"+seatNumber[i]+"</td>");
                        out.print("<td>"+passengerName[i]+"</td>");
                        out.print("<td>"+passengerAge[i]+"</td>");
                    }
                %>
        </tr>
    </table>
