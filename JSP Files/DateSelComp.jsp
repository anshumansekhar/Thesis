...
<body>
    <form>
    <input type="text" name="datum1"><a href="#" onClick="setYears(1947,2008);showCalender(this, 'datum1');">Select Date</a>
...
if (((thisLeft >= calLeft && thisLeft <= calRight)||((thisRight <= calRight) && thisRight >= calLeft)||
						((thisLeft <= calLeft) && (thisRight >= calRight)))&&(((thisTop >= calTop) && (thisTop <= calBottom))||
						((thisBottom <= calBottom) && (thisBottom >= calTop))||((thisTop <= calTop) && (thisBottom >= calBottom))))
				{
